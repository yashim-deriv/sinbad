...
export const positions: PositionsType[] = [
    ...
    {
        id: 'win-ops-eng',
        position: 'WinOps Engineer',
        text: 'We are seeking a WinOps Engineer to deploy product updates, identify and resolve system issues, and perform production operations.',
        description: [
            'Are you passionate about automation? Join our WinOps team and apply all your creativity while working on a complex infrastructure of more than 40 servers. We develop a wide range of products and services offered on MT5, and we set ambitious targets to achieve and retain 24/7 availability to our clients.',
            'With over 400,000 active MT5 accounts, we constantly develop new practices and adopt new technologies to ensure reliable, scalable, and uninterrupted trading operations. Your expertise in systems administration and the Windows environment will be essential in overcoming technical and system challenges while working in an Agile environment.',
            'As a Devops Engineer (Windows) in Deriv, you will be contributing to applying the DevOps mindset in the Windows world. In a rapid growth environment, where our technology stack is constantly updated, you will learn new technologies and apply best practices.',
        ],
        challenges: [
            'Explore the dynamics of new technologies–Octopus Deploy, Terraform–and implement automation procedures on the Windows environment with 30+ servers in an effort to eliminate human intervention.',
            'Implement chaos engineering methodology to the production environment to ensure uninterrupted operations with minimal downtime.',
            'Optimise costs and ensure reliability by deploying and maintaining a cloud-agnostic infrastructure.',
        ...
        good_to_have: [
            ...
            'Experience in Infrastructure as code methodology (Terraform)',
            'Experience in Configuration as code methodology and configuration management platforms (Octopus Deploy)',
    ...
    },
    {
        ...
        text: 'We are seeking a Software Tester to improve the quality of websites, applications, back-end infrastructure, and related systems for leading fintech companies.',
        description: [
            'You’ll engage in quality control throughout the product development lifecycle of all our products, services, and systems. You will help develop test plans and ensure their execution at each stage, from planning until release. We process over a million transactions per day, and we need you to help deliver the best version of every product, fully optimised, free from bugs, and polished for client utilisation. ',
        ],
        challenges: [
            'Perform high-quality automated and manual tests on the Deriv.com website, applications, backend infrastructure, and related systems.',
            ...
            'Integrate various types of testing into our existing internal and external workflows.',
        ...
        team: 'We are the Quality Assurance team. We are software testing engineers who execute high-quality tests to refine our wide range of products and services. We look after our websites and trading platforms’ quality, usability, and stability to deliver a world-class experience to our end users.',
        requirements: [
        ...
        good_to_have: [
            ...
            'Proficiency with one or more programming languages, preferably Perl, but can also be Python, PHP, C/C++, etc.',
        ],
    },
    {
        id: 'dev-ops',
        position: 'DevOps Engineer',
        text: 'We are seeking a DevOps Engineer to work closely with developers and testers to ensure the security and smooth running of all systems.',
        description: [
            'You’ll be deeply involved in every stage of the software lifecycle. You will work closely with developers and testers to facilitate the smooth execution of the continuous integration (CI) process. You must be passionate about connecting software development to day-to-day operations and improving the quality of our products and services.',
        ],
        challenges: [
            ...
            'Help us improve continuously. If you have suggestions for improvement, we’d love to hear about them.',
        ],
        team: 'We are the DevOps team. We collaborate with various teams to ensure successful code deployment, component testing, process re-engineering, and quality improvement. With a holistic view of our technical environment, we provide the best solutions that benefit the company and our clients.',
        requirements: [
            ...
            'Experience inManaging round-the-clock operations for incident resolution, including alerts, rotations, and escalations',
        ...
        good_to_have: [
            ...
            'Experience in Hardening Linux systems',
            'Experience in CI tools such as Travis-CI, CircleCI, Jenkins etc.',
            'Experience in Documentation of processes and incidents',
            'Experience in Version Control software (Git)',
            'Experience in Windows Server Administration (IIS, MS-SQL)',
        ],
    },
]
